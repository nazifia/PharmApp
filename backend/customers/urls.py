...
urlpatterns = [
    path("search/",  views.search_customers_global, name="customer-search-global"),
    path("", views.customer_list, name="customer-list"),
    path("<int:pk>/", views.customer_detail, name="customer-detail"),
    path(
        "<int:pk>/wallet/transactions/", views.wallet_transactions, name="wallet-txns"
    ),
    ...
    path("<int:pk>/wallet/reset/", views.wallet_reset, name="wallet-reset"),
