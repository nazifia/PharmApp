...
INVENTORY_READ  = {'Admin', 'Manager', 'Pharmacist', 'Pharm-Tech',
                   'Salesperson', 'Cashier',
                   'Wholesale Manager', 'Wholesale Operator', 'Wholesale Salesperson'}
RETAIL_POS      = {'Admin', 'Manager', 'Pharmacist', 'Pharm-Tech',
                   'Salesperson', 'Cashier'}
WHOLESALE_POS   = {'Admin', 'Manager',
                   'Wholesale Manager', 'Wholesale Operator', 'Wholesale Salesperson'}
...
TRANSFERS_ROLES = {'Admin', 'Manager', 'Wholesale Manager', 'Wholesale Operator'}
