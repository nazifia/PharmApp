# Generated by Django 5.1.7 on 2025-03-09 10:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0034_alter_receipt_options_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='wholesalereceipt',
            name='receipt_id',
            field=shortuuid.django_fields.ShortUUIDField(alphabet=None, length=10, max_length=20, prefix='WRID:', unique=True),
        ),
        migrations.AlterField(
            model_name='wholesalereceipt',
            name='sales',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='wholesale_receipt', to='store.sales'),
        ),
        migrations.AlterField(
            model_name='wholesalereceipt',
            name='status',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customer.wholesalecustomer'),
        ),
    ]
