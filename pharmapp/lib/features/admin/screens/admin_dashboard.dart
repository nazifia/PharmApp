      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            ...
            _sectionLabel(context, 'Administration', Icons.admin_panel_settings_outlined,
                EnhancedTheme.warningAmber),
            const SizedBox(height: 10),
            Row(children: [
              _card(context, Icons.manage_accounts_rounded, 'Users',
                  EnhancedTheme.warningAmber, '/dashboard/users'),
              const SizedBox(width: 10),
              _card(context, Icons.history_rounded, 'Activity Log',
                  EnhancedTheme.accentPurple, '/dashboard/activity-log'),
              const SizedBox(width: 10),
              _card(context, Icons.notifications_outlined, 'Alerts',
                  EnhancedTheme.infoBlue, '/dashboard/notifications'),
              const SizedBox(width: 10),
              _card(context, Icons.hub_rounded, 'Networks',
                  EnhancedTheme.accentPurple, '/dashboard/network'),
            ]),
            const SizedBox(height: 22),
