                          ...
                          isLoading
                              ? SizedBox(height: 16,
                                  child: LinearProgressIndicator(
                                      ...
                                      backgroundColor: (k['color'] as Color).withValues(alpha: 0.1)).animateInView((a) => a.scaleX(begin: 0, end: 1, alignment: Alignment.centerLeft, duration: 900.ms, curve: Curves.easeOutCubic)))
