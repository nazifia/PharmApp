...
class InventoryReportScreen extends ConsumerWidget {
            ...
            child: Row(children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.refresh_rounded, color: EnhancedTheme.accentCyan, size: 18)),
              ),
          ...
          Expanded(child: reportAsync.when(
            loading: () => Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('Loading inventory…', style: TextStyle(color: EnhancedTheme.primaryTeal.withValues(alpha: 0.8), fontSize: 13)),
              ]),
            ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(22),
                border: Border.all(color: EnhancedTheme.accentCyan.withValues(alpha: 0.28), width: 1.5),
              ),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                    padding: const EdgeInsets.all(9),
                    decoration: BoxDecoration(
                      color: EnhancedTheme.accentCyan.withValues(alpha: 0.18),
                      borderRadius: BorderRadius.circular(12)),
                    child: const Icon(Icons.inventory_2_rounded, color: EnhancedTheme.accentCyan, size: 20)),
                  const SizedBox(width: 14),
                ...
                Row(children: [
                  Expanded(child: _kpiBadge('Total Items', '${data.totalItems}', Icons.inventory_2_rounded, EnhancedTheme.primaryTeal)),
                  const SizedBox(width: 10),
                  Expanded(child: _kpiBadge('Low Stock', '${data.lowStockCount}', Icons.warning_amber_rounded, EnhancedTheme.warningAmber)),
                  const SizedBox(width: 10),
                  Expanded(child: _kpiBadge('Healthy', '${data.totalItems - data.lowStockCount}', Icons.check_circle_rounded, EnhancedTheme.successGreen)),
                ]),
              ]),
            ),
          ),
        ...
        Row(children: [
          Container(
            ...
            child: const Icon(Icons.warning_amber_rounded, color: EnhancedTheme.warningAmber, size: 16)),
          const SizedBox(width: 10),
          Expanded(child: Text('Low Stock Alerts',
          ...
          Container(
            ...
            child: Text('${data.lowStockItems.length} items',
                style: const TextStyle(color: EnhancedTheme.warningAmber, fontSize: 11, fontWeight: FontWeight.w800))),
        ...
        if (data.lowStockItems.isEmpty)
          ...
          ...data.lowStockItems.asMap().entries.map((e) =>
            _lowStockRow(context, e.value, e.key)
          ),
  ...
  Widget _lowStockRow(BuildContext context, LowStockItem item, int index) {
    ...
    ).animate().fadeIn(duration: 350.ms, delay: Duration(milliseconds: 150 + index * 40))
