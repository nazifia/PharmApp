                ...
                builder: (_) => Scaffold(
                  ...
                  body: Center(
                    child: Column(
                      ...
                      children: [
                        const CircularProgressIndicator(color: EnhancedTheme.primaryTeal).animate().fadeIn(duration: 600.ms).scale(begin: const Offset(0.7, 0.7), end: const Offset(1, 1), duration: 600.ms, curve: Curves.easeOutCubic),
