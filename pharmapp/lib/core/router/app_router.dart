...
import 'package:pharmapp/features/prescriptions/screens/prescriber_consultations_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      const publicRoutes = ['/login', '/role-selection', '/setup', '/register-org', '/register-prescriber', '/prescriber-login', '/prescriber-portal', '/prescriber-portal/patients', '/prescriber-portal/write-rx', '/prescriber-portal/commissions', '/prescriber-portal/consultations'];
    ...
    routes: [
      ...
      GoRoute(path: '/prescriber-portal/consultations', name: 'prescriber_consultations', builder: (_, __) => const PrescriberConsultationsScreen()),
